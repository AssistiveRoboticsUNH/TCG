...
from model.sg_perception.packager import *
...
def gen_TFRecord_from_file(bag_filename, timing_filename, flip=False):
    ...
    print('######## count: {}'.format(packager.get_frame_count()))
    packager.formatOutput(start_frame=0, end_frame=packager.get_frame_count())
    ...
    for i in range(p.shape[0]):
        ...
        cv2.imwrite('/home/assistive-robotics/bag/flow/{}.jpg'.format(str(i + 1).zfill(3)), p_img)
    ...
    for i in range(m.shape[0]):
        ...
        cv2.imwrite('/home/assistive-robotics/bag/video/{}.jpg'.format(str(i + 1).zfill(3)), m_img)
...
if __name__ == '__main__':
    ...
    bag_file = os.environ["HOME"] + "/bag/3_emma.bag"
