#ifndef DataCollectionGUI_H
#define DataCollectionGUI_H
...
class DataCollectionGUI : public QWidget{
	Q_OBJECT

	public:
		std::string name = "Madison";
		explicit DataCollectionGUI(QWidget *parent = 0);
		~DataCollectionGUI();
	...
	private:
		Ui::DataCollectionGUI *ui;
		QBasicTimer Mytimer;
		QTimer *timer;
		QString MyClockTimetext;
		ros::NodeHandle n;
		ros::Publisher pub_speak, pub_pose, pub_custom, pub_actFinished, pub_move, pub_record;//, pub_gaze;
